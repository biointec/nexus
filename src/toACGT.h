...
/**
 * @brief Print the old and new character counts for the pan-genome
 *
 */
void printCharacterSubstitutionState();

/**
 * @brief Preprocess a line such that it only contains A, C, G and T
 *
 * @param line The line that is to be preprocessed (will be edited)
 */
